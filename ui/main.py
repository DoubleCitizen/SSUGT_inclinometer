...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_static_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_static_2.setMinimumSize(QtCore.QSize(200, 0))
        self.frame_static_2.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.frame_static_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_static_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_static_2.setObjectName("frame_static_2")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.frame_static_2)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.label_3 = QtWidgets.QLabel(self.frame_static_2)
        font = QtGui.QFont()
        ...
        self.pushButton_time_point_start = QtWidgets.QPushButton(self.frame_static_2)
        self.pushButton_time_point_start.setObjectName("pushButton_time_point_start")
        self.gridLayout_6.addWidget(self.pushButton_time_point_start, 1, 0, 1, 1)
        self.pushButton_time_point_end = QtWidgets.QPushButton(self.frame_static_2)
        self.pushButton_time_point_end.setEnabled(False)
        self.pushButton_time_point_end.setObjectName("pushButton_time_point_end")
        self.gridLayout_6.addWidget(self.pushButton_time_point_end, 2, 0, 1, 1)
        self.lineEdit_indicator_value = QtWidgets.QLineEdit(self.frame_static_2)
        self.lineEdit_indicator_value.setObjectName("lineEdit_indicator_value")
        self.gridLayout_6.addWidget(self.lineEdit_indicator_value, 3, 0, 1, 1)
        self.gridLayout.addWidget(self.frame_static_2, 1, 0, 2, 1)
        self.frame_static_1 = QtWidgets.QFrame(self.centralwidget)
        self.frame_static_1.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_static_1.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_static_1.setObjectName("frame_static_1")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.frame_static_1)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.label_4 = QtWidgets.QLabel(self.frame_static_1)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_timer = QtWidgets.QLabel(self.frame_static_1)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.action_static_mode = QtWidgets.QAction(MainWindow)
        self.action_static_mode.setCheckable(True)
        self.action_static_mode.setObjectName("action_static_mode")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Функционал режима статики"))
        self.pushButton_time_point_start.setText(_translate("MainWindow", "Поставить временную точку"))
        self.pushButton_time_point_end.setText(_translate("MainWindow", "Завершить временную точку"))
        ...
        self.action_static_mode.setText(_translate("MainWindow", "Отобразить режим статики"))
